...
for processes in 2 4 8; do
    for dir in ./solved_grids/*; do
        ...
        if [ $file_count -lt 15 ]; then # test each file as the starting point and verify all the next possible iterations from that file
            continue
            ...
            for i in $(seq 0 $(($file_count - 1))); do
                ...
                echo -e "\e[34mTesting $dir/00.txt for $i iterations\e[0m"
